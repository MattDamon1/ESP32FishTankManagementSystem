...
// float ds18b20_get_temp(OLEDDisplay_t *oled)
// {
//     unsigned char check;
//     char temp1 = 0, temp2 = 0;
//     static uint8_t Ds18b20Step = 0;
//     // ESP_LOGI("TAG", "init == %d",init);
//     if (init == 1)
//     {
//         if (Ds18b20Step == 0)
//         {
...
//                 register_counter(oled, ds18b20_delay_timer, 8 * COUNT_100_MS);
//                 Ds18b20Step++;
//             }
//                 else
//             {
...
//             }
//         }
//         else if (Ds18b20Step == 1)
//         {
//             if (get_counter(oled, ds18b20_delay_timer) == 0)
//             {
//                 check = ds18b20_RST_PULSE();
//                 ds18b20_send_byte(0xCC);
...
//                 return temp;
//                 Ds18b20Step = 0;
//                 ESP_LOGI("TAG", "get_counter ds18b20_delay_timer trig");
//             }
//         }
//     }
//     else
