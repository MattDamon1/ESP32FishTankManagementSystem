 ...
 *      Date time structure
 */
void DS1302_setDateTime(DS1302_Dev *dev, type_stru_DS1302_DateTime *dateTime)
{
    uint8_t ch;
 ...
 */
bool DS1302_getDateTime(DS1302_Dev *dev, type_stru_DS1302_DateTime *dateTime)
{
    uint8_t buf[7];
        ...
        (dateTime->year > 2099))
    {
        ...
        memset(dateTime, 0x00, sizeof(type_stru_DS1302_DateTime));
        return false;
    }
...
{
    type_stru_DS1302_DateTime dt = { 0 };
