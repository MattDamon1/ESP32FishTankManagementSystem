...
#define AUTH_TOKEN_MAX_SIZE (32) /**< MAX size of auth token */
    ...
    typedef enum
    {
        ...
        QCLOUD_EVENT_MQTT_CONNECTED,        // Mqtt连接成功
        QCLOUD_EVENT_MQTT_DISCONNECTED,     // Mqtt连接失败
    ...
    typedef struct esp_qcloud_method
    {
        ...
        SLIST_HEAD(method_param_list_, esp_qcloud_param)
        method_param_list;
    } esp_qcloud_method_t;
